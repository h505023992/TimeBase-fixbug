...
do
  ...
  python -u run_longExp.py \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 30 >logs/LongForecasting/DLinear/${model_name}_traffic_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >logs/LongForecasting/DLinear/${model_name}_Etth1_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 321 \
      --des 'Exp' \
      --itr 1 >logs/LongForecasting/DLinear/${model_name}_electricity_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
    ...
    --des 'Exp' \
    --itr 1 \
    --train_epochs 30 >logs/LongForecasting/DLinear/${model_name}_weather_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >logs/LongForecasting/DLinear/${model_name}_Etth2_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >logs/LongForecasting/DLinear/${model_name}_Ettm1_${seq_len}_${pred_len}.log
  ...
  python -u run_longExp.py \
      ...
      --c_out 7 \
      --des 'Exp' \
      --itr 1  >logs/LongForecasting/DLinear/${model_name}_Ettm2_${seq_len}_${pred_len}.log
done
done
done